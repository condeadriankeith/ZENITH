...
## Key Elements
- **Prismatic imagery** and **left-hand motifs** throughout
- **Systems-minded magic** with technical consequences
- **Repeating sensory Ruination** (Name-Bleed)
- Complex political dynamics among institutions

## Navigation
This repository contains comprehensive worldbuilding materials organized into thematic sections:
- [Codex entries](./codex/) - In-world documents and lore
- [Magic systems](./systems/) - Rules and mechanics
- [Lore entries](./lore/) - Detailed background stories
- [Character bible](./characters/) - Character development materials
- [Narrative flow](./narrative_flow/) - Story planning and structure
