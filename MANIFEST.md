...
| `codex/` | Static Lore: History, Geography (Atlas), Bestiary, and Fracture events. |
...
| `_archive/` | Early concepts and non-active drafts. |
| `art_and_aesthetics/` | Visual and auditory inspiration/motifs. |
| `compendium/` | Consolidated reference materials. |
| `editorial/` | Style guides, checklists, and validation reports. |
| `templates/` | Reusable structures for scenes and chapters. |

## Key Files

- `manuscript/00_prologue.md`: The only active story draft.
- `manuscript/frontmatter.md`: Title, Dedication, and Blurb.
- `codex/genesis_myth.md`: The canonical creation myth of Aethelgard.
- `codex/atlas.md`: The geography and Shard-alignment of the world.
- `codex/factions.md`: The motivations and goals of the world's power players.
- `editorial/style_guide.md`: The "Writing Constitution" for the project.
